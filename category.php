...
if($rowcount==0)
{
echo "It looks like there’s nothing here right now, but stay tuned for more news!";
}
else {
...
?>
<h1 class="abc"><?php echo htmlentities($row['category']);?> News</h1>
<div>
...
<?php } ?>
    ...
    <ul class="pagination justify-content-center mb-4">
        <li class="page-item"><a href="?pageno=1"  class="page-link"><div class="news-title">First</div></a></li>
        ...
        <li class="page-item"><a href="?pageno=<?php echo $total_pages; ?>" class="page-link"><div class="news-title">Last</div></a></li>
    </ul>
<?php } ?>
